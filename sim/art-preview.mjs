...
// ── Per-district materials (all DARK + desaturated — noir; identity is subtle tint + value) ──
const MAT = {
  financial:   { roof: [47, 46, 51], walk: [38, 38, 43] }, // warm neutral marble-grey
...
const NEON = [[44, 232, 208], [255, 59, 200], [255, 176, 32], [255, 80, 80], [73, 184, 255], [143, 107, 255]];
