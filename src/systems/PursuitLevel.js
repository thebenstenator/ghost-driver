  ...
  static defaultConfig() {
    return {
      ...
      levels: [
        ...
        { span: 35,  cap: 2,  reinforce: 15, cooldown: 20, reaction: 0.18, boxTrigger: 150, searchers: 2,
          roster: { patrol: 2 } },                                                   // L1
        { span: 60,  cap: 4,  reinforce: 18, cooldown: 30, reaction: 0.10, boxTrigger: 220, searchers: 3,
          roster: { patrol: 4 } },                                                   // L2
        { span: 120, cap: 6,  reinforce: 25, cooldown: 35, reaction: 0.08, boxTrigger: 240, searchers: 4,
          roster: { interceptor: 2, patrol: 4 }, roadblocks: true },                 // L3
        { span: 240, cap: 10, reinforce: 30, cooldown: 40, reaction: 0.06, boxTrigger: 260, searchers: 5,
          roster: { heavy: 2, interceptor: 2, spike: 1, patrol: 5 }, roadblocks: true }, // L4
        { span: 0,   cap: 16, reinforce: 40, cooldown: 45, reaction: 0.05, boxTrigger: 280, searchers: 6,
